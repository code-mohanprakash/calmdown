...
extension Color {
    ...
    // Stress Level Colors
    static let stressGreat    = Color(hex: "#4CAF50")   // Great
    static let stressGood     = Color(hex: "#8BC34A")   // Good
    static let stressNormal   = Color(hex: "#FFC107")   // Normal
    static let stressHigh     = Color(hex: "#FF9800")   // High
    static let stressOverload = Color(hex: "#F44336")   // Overload

    // Chart Colors (soft pastels)
    static let chartBlue      = Color(hex: "#AED6F1")
    static let chartPink      = Color(hex: "#F1948A")
    static let chartGreen     = Color(hex: "#A9DFBF")
    static let chartPurple    = Color(hex: "#D2B4DE")
    static let chartOrange    = Color(hex: "#FAD7A0")
    static let chartTeal      = Color(hex: "#A2D9CE")
    static let chartRed       = Color(hex: "#F1948A")
}
